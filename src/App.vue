<template>
  <div id="app">
    <with-keyboard-control ref="keyEvent" :listLength="$options.list.length" @selected="selectedHandler" class="list">
...
export default {
  ...
  methods: {
    ...
    clickedHandler(idx) {
      this.$refs.keyEvent.$data.selectedIndex = idx;
      this.selectedHandler(idx);
    }
  },
  created() {
    this.$options.list = [
